...
function Navbar() {
  ...
  const navItems: Array<{ label: string; section: string } | { label: string; href: string }> = [{ label: 'About', section: 'about' }, { label: 'Experience', section: 'experience' }, { label: 'Projects', href: '/projects' }]
